...
typedef float(joypad_readsixaxis)(void* ctx, ControllerNumber player, SixAxisMotionTypes type,
                                  PluginDefinitions::ControllerType joycon_type);
typedef void(joypad_setsixaxis)(void* ctx, ControllerNumber player, SixAxisMotionTypes type,
                                PluginDefinitions::ControllerType joycon_type, float val);
...
typedef void(gui_drawpixel)(void* ctx, uint32_t x, uint32_t y, uint8_t red, uint8_t green,
